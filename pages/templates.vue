          ...
          <div class="col-6">
            ...
            <div v-if="widgetType == 'numberchart'">
              ...
              <base-input
                ...
                label="Tiempo de respuesta del gráfico (mins)"
                type="number"
              ></base-input>
              ...
              <el-select
                ...
                :class="`select-${ncConfig.class}`"
                placeholder="Ancho del complemento"
                style="width: 100%;"
              >
                <el-option
                  class="text-dark"
            ...
            <div v-if="widgetType == 'switch'">
              ...
              <el-select
                ...
                :class="`select-${iotSwitchConfig.class}`"
                placeholder="Estilo"
                style="width: 100%;"
              >
                <el-option
            ...
            <div v-if="widgetType == 'button'">
              ...
              <el-select
                ...
                :class="`select-${configButton.class}`"
                placeholder="Estilo"
                style="width: 100%;"
              >
                <el-option
            ...
            <div v-if="widgetType == 'indicator'">
              ...
              <el-select
                ...
                :class="`select-${iotIndicatorConfig.class}`"
                placeholder="Estilo"
                style="width: 100%;"
              >
                <el-option
      ...
      <card>
        ...
        <div class="row">
          <el-table :data="templates">
            <div slot="empty">No hay datos para mostrar</div>
      ...
      try {
        ...
        if (res.data.status == "fail" && res.data.error == "template in use") {
          this.$notify({
            ...
            message:
              template.name +
              " se encuentra en uso. Primero debe remover el dispositivo vinculado al template."
          });
